...
@section("content")
    ...
    <div class="row mt-4 d-flex justify-content-center {{$colorSecundario}}">
        @if ($productos->imagen == "")
            <img src="{{url('/img/default.png')}}" alt="Sin imagen" class="img-fluid col-md-5"><br>
        @else
            <img class="img-fluid col-md-5" src="{{asset('/img')}}/{{$productos->imagen}}" alt="{{$productos->imagen}}">
        @endif
